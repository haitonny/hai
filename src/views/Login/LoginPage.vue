  ...
  <div class="hello">
    <div class="grid h-screen sm:grid-cols-1 xl:grid-cols-2">
      <div class="self-center w-1/2 mx-auto mt-24">
        ...
        <a
          class="inline-flex w-full border border-neutral-400 cursor-pointer my-6 items-center py-2"
        >
          <img
            class="h-4 inline ml-4"
        ...
        <p class="mb-6">or</p>
        <input
          class="form-input mb-6 w-full"
          type="text"
          placeholder="Email"
        /><br />
        <input
          class="form-input w-full mb-20"
          type="text"
      ...
      >
        <div class="lg:max-w-1/4 mt-32">
          <div class="bg-neutral-000 py-2 rounded-r">
            <h5
              class="text-success-500 font-bold bg-neutral-000 border-l-4 rounded-l-sm ml-2 py-1"
            >
              {{ New }}
            </h5>
          </div>
          <div class="text-left pt-8 ml-6">
            <p class="font-bold my-8 leading-none text-5xl">{{ Order }}</p>
            <h6 class="mb-8 font-semibold leading-none">{{ Printify }}</h6>
            <p class="mb-20 text-xs">{{ If }}</p>
            <p class="font-semibold text-xs">{{ Enable }}</p>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      Enable: "Enable in your store settings. More info in our help center",
    };
  },
};
</script>
